...
#define WINDOW_CLASSNAME    "PortalGL"  // Window class name
     ...
     m_bFullScreen(bFullScreen)
{
	...
	m_pStateManager->ChangeState(CMenuState::GetInstance(m_pStateManager),1);
...
void CMainWindow::OnSize(GLsizei width1, GLsizei height1)
{
	width = width1; height = height1;
	glViewport(0,0,width,height);
	if (m_pStateManager->getCurrentState() == 1)
	{
...
void CMainWindow::Mouse_Move(int wndWidth, int wndHeight)
{
