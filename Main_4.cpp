...
void Fire()
{
	...
	while (Collision_Detection(pl2,pozicija,smer,rt,norma)!=1)
	{

		pozicija.x = pozicija.x  + smer.x * BULLETSPEED;
		pozicija.y = 1;
		pozicija.z = pozicija.z  + smer.z * BULLETSPEED;
